...
type JobListingCardProps = {
  ...
  JobListing,
  'title' | 'companyName' | 'experienceLevel' | 'shortDescription' | 'salary' | 'location' | 'type'
>
...
export function JobListingCard({
  ...
  return (
    <Card className={cn('h-full flex flex-col', className)}>
      ...
      <CardFooter className='flex gap-2 items-stretch justify-end'>{footerBtns}</CardFooter>
    </Card>
  )
}
